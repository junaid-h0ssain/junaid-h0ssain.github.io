...
export const PROJECTS: Project[] = [
  ...
  {
    repo: "junaid-h0ssain/react_native_expo",
    title: "react_native_expo",
    badge: "TypeScript",
    description: "Small React Native/Expo projects.",
    tags: ["TypeScript", "React Native", "Expo"],
  },
  {
    repo: "junaid-h0ssain/comp-react",
    title: "comp-react",
    badge: "TypeScript",
    description: "Practising React components.",
    tags: ["TypeScript", "React"],
    liveUrl: "https://comp-react.junadhon81.workers.dev/",
  },
  {
    repo: "junaid-h0ssain/go-react-todo-list",
    title: "go-react-todo-list",
    badge: "Go",
    description: "A todo list app with a Go backend and React frontend.",
    tags: ["Go", "React"],
  },
  {
    repo: "junaid-h0ssain/insert",
    title: "insert",
    badge: "TypeScript",
    description: "An attempt at an online Cursor clone.",
    tags: ["TypeScript"],
  },
  {
    repo: "junaid-h0ssain/astro-learn",
    title: "astro-learn",
    badge: "Astro",
    description: "Learning Astro with small experiments.",
    tags: ["Astro"],
    liveUrl: "https://junaid-h0ssain.github.io/astro-learn/",
  },
  {
    repo: "junaid-h0ssain/go-crud-api",
    title: "go-crud-api",
    badge: "Go",
    description: "A simple CRUD API in Go for learning.",
    tags: ["Go"],
  },
  {
    repo: "junaid-h0ssain/go-learn",
    title: "go-learn",
    badge: "Go",
    description: "An API made to learn auth and data handling with Go.",
    tags: ["Go"],
  },
  {
    repo: "junaid-h0ssain/fakeRSA",
    title: "fakeRSA",
    badge: "Java",
    description: "Practising RSA implementation in Java.",
    tags: ["Java"],
  },
  {
    repo: "junaid-h0ssain/data-management",
    title: "data-management",
    badge: "TypeScript",
    description: "A data management web app.",
    tags: ["TypeScript"],
    liveUrl: "https://data-management-ebon.vercel.app",
  },
  {
    repo: "junaid-h0ssain/harvest-guard",
    title: "harvest-guard",
    badge: "JavaScript",
    description: "Harvest Guard — a crop monitoring web app.",
    tags: ["JavaScript"],
    liveUrl: "https://perplex1.vercel.app",
  },
  {
    repo: "junaid-h0ssain/crime-platform",
    title: "crime-platform",
    badge: "JavaScript",
    description: "A hackathon project — crime reporting platform.",
    tags: ["JavaScript"],
  },
  {
    repo: "junaid-h0ssain/vigilantef",
    title: "vigilantef",
    badge: "Svelte",
    description: "VigilanteF web app.",
    tags: ["Svelte"],
    liveUrl: "https://vigilantef.vercel.app",
  },
  {
    repo: "junaid-h0ssain/java-assignment-1",
    title: "java-assignment-1",
    badge: "Java",
    description: "A CLI-based shop inventory app.",
    tags: ["Java"],
  },
  {
    repo: "junaid-h0ssain/kidss",
    title: "kidss",
    badge: "Dart/Flutter",
    description: "A Flutter app using the Hive database.",
    tags: ["Flutter", "Dart", "Hive"],
  },
  {
    repo: "junaid-h0ssain/SuperShop",
    title: "SuperShop",
    badge: "PHP",
    description: "A SuperShop management app.",
    tags: ["PHP"],
  },
  {
